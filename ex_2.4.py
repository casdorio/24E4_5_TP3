...
print(f"Números primos encontrados: {prime_count_seq}")
print(f"Tempo (Sequencial): {end_seq - start_seq:.6f} segundos")
print(f"Memória usada (Sequencial): {current_seq / 1024:.2f} KB | Pico: {peak_seq / 1024:.2f} KB")

print("\nExecução Paralela:")
print(f"Tempo (Paralela): {end_par - start_par:.6f} segundos")
print(f"Memória usada (Paralela): {current_par / 1024:.2f} KB | Pico: {peak_par / 1024:.2f} KB")
